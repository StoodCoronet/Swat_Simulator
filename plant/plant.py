...
# Form implementation generated from reading ui file 'plant.py'
#
...
class plant:
    ...
    def changeValueBF(self, result0, result1, result2, k): # Mr.Brute and Mr.Force, so BF :D
        #print("Plant.changeValue" + k)
